...
@rem ##########################################################################
@rem
@rem  griffon-hwlist startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute griffon-hwlist
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" io.github.aretche.hwlist.Launcher %CMD_LINE_ARGS%
